...
import {
  ...
  type ChapterEventsReviewPrisma
} from "@/server/modules/review/chapterEvents";

function createService(overrides: Partial<ChapterEventsReviewPrisma> = {}) {
  const mocks = {
  ...
  const tx = {
    ...
    ...overrides
  } as unknown as ChapterEventsReviewPrisma;
  ...
  return {
    mocks,
    tx,
    service: createChapterEventsReviewService(prisma)
  };
}

describe("chapterEvents review service", () => {
