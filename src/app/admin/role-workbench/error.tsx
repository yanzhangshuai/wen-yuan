 ...
 * -----------------------------------------------------------------------------
 * 文件路径：`app/admin/role-workbench/error.tsx`
 *
 * 框架语义：
 ...
 * =============================================================================
 */
export default function RoleWorkbenchError({
  error,
  reset
}: {
  /**
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] px-4 text-center">
      ...
      <h2 className="text-2xl font-bold mb-2">角色资料出错</h2>
